...
set(ACTAR_INCLUDE_DIR "${ACTARLIB}/include")
set(ACTAR_LIB_DIR "${ACTARLIB}/lib")

# Look for Root   
include("${ACTARLIB}/ressources/CMake/Root.cmake")  
...
# set ACTARLib/lib as one of the link directory
link_directories(${ACTAR_LIB_DIR})
